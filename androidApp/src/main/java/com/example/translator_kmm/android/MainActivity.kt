...
import com.example.translator_kmm.android.translate.presentation.Routes
    ...
    NavHost(
        ...
        composable(route = Routes.TRANSLATE) {
            ...
            LaunchedEffect(key1 = voiceResult) {
                viewModel.onEvent(TranslateEvent.SubmitVoiceResults(voiceResult))
        ...
        composable(
            ...
            val languageCode = backStackEnter.arguments?.getString("languageCode") ?: "en"
