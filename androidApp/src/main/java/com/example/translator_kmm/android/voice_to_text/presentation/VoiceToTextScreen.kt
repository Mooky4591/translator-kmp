                        ...
                        when (displayState) {
                            DisplayState.SPEAKING -> {
                                Icon(
                                    ...
                                    contentDescription = stringResource(id = com.example.translator_kmm.R.string.stop_recording),
                            ...
                            DisplayState.DISPLAYING_RESULTS -> {
                                Icon(
                                    ...
                                    contentDescription = stringResource(id = com.example.translator_kmm.R.string.apply),
                                    modifier = Modifier.size(50.dp)
                                )
                            }
                            else -> {
                                Icon(
                                    ...
                                    contentDescription = stringResource(id = com.example.translator_kmm.R.string.record_audio),
                                    modifier = Modifier.size(50.dp)
                                )
                            }
                        }
                ...
                if (state.displayState == DisplayState.DISPLAYING_RESULTS) {
                    IconButton(onClick = {
                        ...
                        Icon(
                            ...
                            contentDescription = stringResource(id = com.example.translator_kmm.R.string.record_again),
                            tint = LightBlue
                        )
                    }
                }
